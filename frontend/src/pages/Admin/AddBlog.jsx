...
if(data.success){
  ...
  return (
 <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-500 h-full overflow-scroll'>
  <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
    ...
    p-2 border border-gray-300 outline-0 rounded
    '
    ...
    <select onChange={(e)=> setCategory(e.target.value)} name="category" className='mt-2 px-3 py-2 border text-gray-500 border0gray-300 outline-none rounded'>
     <option value="">Select Category</option>
            ...
            return  <option key={index} value={image}>{item}</option>
            })}
    </select>
